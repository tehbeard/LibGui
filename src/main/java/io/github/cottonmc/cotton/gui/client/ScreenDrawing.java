...
public class ScreenDrawing {
	 ...
	 */
	public static void texturedRect(GuiGraphicsExtractor context, int x, int y, int width, int height, Identifier texture, int color) {
	 ...
	 * @since 2.0.0
	 */
	public static void texturedRect(GuiGraphicsExtractor context, int x, int y, int width, int height, Identifier texture, int color, float opacity) {
	 ...
	 * @param color   a color to tint the texture. This can be transparent! Use 0xFF_FFFFFF if you don't want a color tint
	 */
	public static void texturedRect(GuiGraphicsExtractor context, int x, int y, int width, int height, Identifier texture, float u1, float v1, float u2, float v2, int color) {
	 ...
	 * @since 3.0.0
	 */
	public static void texturedRect(GuiGraphicsExtractor context, int x, int y, int width, int height, Texture texture, int color) {
	 ...
	 * @since 3.0.0
	 */
	public static void texturedRect(GuiGraphicsExtractor context, int x, int y, int width, int height, Texture texture, int color, float opacity) {
		switch (texture.type()) {
			...
			case GUI_SPRITE -> {
				outer: if (texture.u1() == 0 && texture.u2() == 1 && texture.v1() == 0 && texture.v2() == 1) {
					...
					context.blitSprite(RenderPipelines.GUI_TEXTURED, texture.image(), x, y, width, height, color);
				} else {
					...
					context.blitSprite(RenderPipelines.GUI_TEXTURED, texture.image(), 0, 0, width, height, color);
	 ...
	 * @since 2.0.0
	 */
	public static void texturedRect(GuiGraphicsExtractor context, int x, int y, int width, int height, Identifier texture, float u1, float v1, float u2, float v2, int color, float opacity) {
		if (width <= 0) width = 1;
	 ...
	 * @param color    a color to tint the texture. This can be transparent! Use 0xFF_FFFFFF if you don't want a color tint
	 */
	public static void texturedGuiRect(GuiGraphicsExtractor context, int x, int y, int width, int height, Identifier texture, int textureX, int textureY, int color) {
		float px = 1/256f;
	 ...
	 * @param color   a color to tint the texture. This can be transparent! Use 0xFF_FFFFFF if you don't want a color tint
	 */
	public static void texturedGuiRect(GuiGraphicsExtractor context, int left, int top, int width, int height, Identifier texture, int color) {
	 ...
	 */
	public static void coloredRect(GuiGraphicsExtractor context, int left, int top, int width, int height, int color) {
		if (width <= 0) width = 1;
		if (height <= 0) height = 1;
	 ...
	 */
	public static void drawGuiPanel(GuiGraphicsExtractor context, int x, int y, int width, int height) {
	 ...
	 */
	public static void drawGuiPanel(GuiGraphicsExtractor context, int x, int y, int width, int height, int panelColor) {
	 ...
	 */
	public static void drawGuiPanel(GuiGraphicsExtractor context, int x, int y, int width, int height, int shadow, int panel, int hilight, int outline) {
	 ...
	 */
	public static void drawBeveledPanel(GuiGraphicsExtractor context, int x, int y) {
	 ...
	 */
	public static void drawBeveledPanel(GuiGraphicsExtractor context, int x, int y, int width, int height) {
	 ...
	 */
	public static void drawBeveledPanel(GuiGraphicsExtractor context, int x, int y, int width, int height, int topleft, int panel, int bottomright) {
	 ...
	 */
	public static void drawString(GuiGraphicsExtractor context, String s, HorizontalAlignment align, int x, int y, int width, int color) {
		var textRenderer = Minecraft.getInstance().font;
		switch (align) {
			case LEFT -> {
				context.text(textRenderer, s, x, y, color, false);
			}

			case CENTER -> {
				int wid = textRenderer.width(s);
				int l = (width / 2) - (wid / 2);
				context.text(textRenderer, s, x + l, y, color, false);
			}
	 ...
	 * @since 1.9.0
	 */
	public static void drawString(GuiGraphicsExtractor context, FormattedCharSequence text, HorizontalAlignment align, int x, int y, int width, int color) {
		var textRenderer = Minecraft.getInstance().font;
		switch (align) {
			case LEFT -> {
			...
			case CENTER -> {
				...
				int l = (width / 2) - (wid / 2);
				context.text(textRenderer, text, x + l, y, color, false);
			}
	 ...
	 * @param color   the text color
	 */
	public static void drawStringWithShadow(GuiGraphicsExtractor context, String s, HorizontalAlignment align, int x, int y, int width, int color) {
		var textRenderer = Minecraft.getInstance().font;
		switch (align) {
			case LEFT -> {
				context.text(textRenderer, s, x, y, color, true);
			}

			case CENTER -> {
				int wid = textRenderer.width(s);
				int l = (width / 2) - (wid / 2);
				context.text(textRenderer, s, x + l, y, color, true);
			}
	 ...
	 * @param color   the text color
	 */
	public static void drawStringWithShadow(GuiGraphicsExtractor context, FormattedCharSequence text, HorizontalAlignment align, int x, int y, int width, int color) {
		var textRenderer = Minecraft.getInstance().font;
		switch (align) {
			case LEFT -> {
			...
			case CENTER -> {
				int wid = textRenderer.width(text);
				int l = (width / 2) - (wid / 2);
				context.text(textRenderer, text, x + l, y, color, true);
			}
	 ...
	 * @param color   the text color
	 */
	public static void drawString(GuiGraphicsExtractor context, String s, int x, int y, int color) {
		context.text(Minecraft.getInstance().font, s, x, y, color, false);
	}
	 ...
	 * @param color   the text color
	 */
	public static void drawString(GuiGraphicsExtractor context, FormattedCharSequence text, int x, int y, int color) {
		context.text(Minecraft.getInstance().font, text, x, y, color, false);
	}
	 ...
	 * @since 4.0.0
	 */
	public static void drawTextHover(GuiGraphicsExtractor context, @Nullable Style textStyle, int x, int y) {
		// TODO: This is private, text might handle
